    ...
    selectPieceXY(value) {
      ...
      if (piece === "p" && this.turn === "white") {
        ...
        if (fromCol >= 0 && fromRow >= 0) {
          if (pawnsWhite1 !== "" && pawnsWhite1.toLowerCase() !== piece) {
            this.validMoves.push([fromRow - 1, fromCol - 1]);
          }
          if (pawnsWhite2 !== "" && pawnsWhite2.toLowerCase() !== piece) {
            this.validMoves.push([fromRow - 1, fromCol + 1]);
          }
      ...
      if (piece === "P" && this.turn === "black") {
        ...
        if (fromCol <= 7 && fromRow <= 7) {
          if (pawnsBlack1 !== "" && pawnsBlack1.toUpperCase() !== piece) {
            this.validMoves.push([fromRow + 1, fromCol + 1]);
          }
          if (pawnsBlack2 !== "" && pawnsBlack2.toUpperCase() !== piece) {
            this.validMoves.push([fromRow + 1, fromCol - 1]);
          }
          if (this.board[fromRow + 1][fromCol] === "") {
            this.validMoves.push([fromRow + 1, fromCol]);
